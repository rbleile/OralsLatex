...
%
Efforts in Ray Tracing using the EAVL/VTK-m framework showed significant success and provide similar workloads to those used in Monte Carlo transport problems.
%
...
%
Looking now at Bleile's work with a Monte Carlo mini app, ALPSMC~\cite{alpsmc1}~\cite{alpsmc2}, the Monte Carlo algorithmic question of event based versus history based algorithms in a simplified Monte Carlo code was evaluated, while also studying the effects different parallel paradigms have on performance and ease of code conversion.
%
