...
%
In other fields a promising approach is displayed in the use of portable performance abstractions in order to specify the tasks to parallelize.
%
These abstractions provide the foundations for applications to write code once and run on any supported platform.
%
This paper describes the state of the art in Monte Carlo neutron transport, with a special emphasis on the effects of upcoming architectures.
%
\end{abstract}
...
\input{OralsIntro.tex}

\input{WhatIsMCNT.tex}

\input{SotAResearch.tex}
	\input{ParallelPerformance.tex}
	\input{LoadBalance.tex}
	\input{NuclearData.tex}
	\input{VarianceReduction.tex}

\input{SotAGPU.tex}
	\input{FirstPass.tex}
	\input{MCMedical.tex}
	\input{MCRayTrace.tex}
	\input{EventBased.tex}

\input{WhatIsPortablePerformance.tex}
